...
<%
	'**************************************************************
	' 본인인증 서명상태를 확인합니다.
	' - https://www.kakaocert.com/docs/verifyAuth/API/asp#GetVerifyAuthState'
	'**************************************************************
	...
	' 접수 아이디
	Dim receiptID : receiptID = "022051917151400001"
	
	On Error Resume Next

	Dim result : Set result = m_KakaocertService.GetVerifyAuthState(clientCode, receiptID)
