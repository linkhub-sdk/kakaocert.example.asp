...
<%
	...
	' - https://www.kakaocert.com/docs/verifyAuth/API/asp#F-VerifyAuth
	'**************************************************************
	...
	' 접수 아이디
	Dim receiptID : receiptID = "022050416455800001"
	

	On Error Resume Next

		Dim result : Set result = m_KakaocertService.VerifyAuth(clientCode, receiptID)
